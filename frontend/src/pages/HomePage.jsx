...
const CATEGORY_ORDER = ['livebirds', 'eggs', 'pickles', 'dairy', 'dryfruits', 'oils', 'millets'];
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
            ...
            try {
                ...
                const apiCategory = selectedCategory === 'livebirds' ? 'meat' : selectedCategory;
