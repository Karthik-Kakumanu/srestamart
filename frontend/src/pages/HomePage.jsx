...
import { 
    ...
    Menu, X, ChevronRight, User, Truck, Search, ShoppingCart, Store, Info, Phone, Mail, Globe, Instagram
} from 'lucide-react';
            ...
            <div className="mt-8 pt-6 border-t border-gray-700/50 text-center text-sm">
                ...
                <div className="mt-3 text-xs text-gray-500">
                    ...
                    <div className="flex items-center justify-center gap-x-4 mt-2">
                        ...
                        <a href="https://instagram.com/pixelkode.co" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 font-semibold text-gray-400 hover:text-white transition-colors">
                            <Instagram size={14}/>
                            PixelKode Instagram
                        </a>
                    </div>
                        ...
                        <motion.div key={selectedCategory + searchQuery} variants={productGridVariants} initial="hidden" animate="visible" className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6" >
                            {productsLoading ? (
                                ...
                                <div className="col-span-full text-center py-12 flex flex-col items-center gap-4">
                                    <FilterX className="text-red-400/50" size={48} />
                                    <p className="text-white text-lg">No products found in this category.</p>
                                    <p className="text-gray-400 text-sm">Please check back later or select another category.</p>
                                </div>
                            )}
                        </motion.div>
