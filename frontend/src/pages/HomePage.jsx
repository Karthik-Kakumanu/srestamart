...
export default function HomePage({ handleAddToCart }) {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/products?page=1&limit=1000`);
                        ...
                        >
                            ...
                            <nav className="flex-grow">
                                ...
                                <ul className="space-y-2">
                                     ...
                                     <li>
                                        <a href="/delivery" className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-md font-medium text-gray-700 hover:bg-gray-100">
